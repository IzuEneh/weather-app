...
function displayWeather(data) {
  ...
  time.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'EEE, MMM do hh:mm bbbb');
